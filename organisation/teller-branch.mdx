...
domain/
  ...
  TellerJournal.java           — empty marker class (journal read data is in data/TellerJournalData.java)
...
sequenceDiagram
    ...
    participant CWPS as PortfolioCommandSourceWritePlatformService
...
CashierTransactionsWithSummaryData retrieveCashierTransactionsWithSummary(
    Long cashierId,
    boolean includeAllTellers,
    LocalDate fromDate,
    LocalDate toDate,
