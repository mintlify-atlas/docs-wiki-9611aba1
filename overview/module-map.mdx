...
| `fineract-accounting` | GL accounts, journal entries, periodic accruals, accounting rules | `org.apache.fineract.accounting` |
...
| `fineract-client-feign` | Feign-based client wrappers around `fineract-client` | `org.apache.fineract.client.feign` |
| `fineract-doc` | AsciiDoc / OpenAPI documentation generation tasks | N/A (doc generation) |
